...
export function BlogShelf({ articles }) {
  ...
  return <div className="blog-studio wrap">
    ...
    {topic === "All" && !query && <section className="bs-featured" aria-labelledby="bs-featured-heading"><div className="bs-section-title"><div><p className="bs-eyebrow">// A GOOD PLACE TO START</p><h2 id="bs-featured-heading">From my workbench <span>✦</span></h2></div><span>Ideas worth exploring</span></div><div className="bs-grid">{[articles[0], articles[1], articles[16], articles[17]].map(a => <Card article={a} key={a.slug} />)}</div></section>}
